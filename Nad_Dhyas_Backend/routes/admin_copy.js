...
router.delete('/students/:id', async (req, res) => {
    ...
    try {
        ...
        // Only the specific "root" user can delete students - strict check
        if (admin.role !== 'ROOT' || admin.username !== 'root') {
            return res.status(403).json({
                success: false,
                error: 'Only the root administrator (username: root) can delete students. Other admins do not have delete permissions.'
            });
        }
